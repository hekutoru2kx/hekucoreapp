...
namespace Hekucoreapp.Application.Resources;
...
// vary by which user triggered the action, or the log stream becomes an unsearchable mix of
// languages. English-only today; a LogMessages.es.resx could be added later without changing
// this resolution behavior.
public static class LogText
{
    private static readonly ResourceManager ResourceManager =
        new("Hekucoreapp.Application.Resources.LogMessages", typeof(LogText).Assembly);
