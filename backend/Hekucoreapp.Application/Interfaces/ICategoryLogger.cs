...
public static class CategoryLoggerExtensions
{
    ...
    // — also sidesteps having to name Hekucoreapp.Domain.Enums.LogLevel directly in a project like
    // Hekucoreapp.Api where Microsoft.Extensions.Logging.LogLevel is an implicit using and the two
    // would collide.
