...
// exist on the schema for future consumers (e.g. a ludemia-style content list) but have no
// sanitization/validation pipeline yet — that lands with the first consumer that needs it.
