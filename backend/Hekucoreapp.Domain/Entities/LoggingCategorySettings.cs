...
// through the API — only ever six rows exist) holding the live admin-set minimum severity for
// that category. LoggingSettingsRefreshHostedService polls these and pushes them into the running
// CategoryLevelSwitches, so a change here takes effect without a restart.
