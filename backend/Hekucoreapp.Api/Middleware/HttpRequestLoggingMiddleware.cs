...
using LogLevel = Hekucoreapp.Domain.Enums.LogLevel;
...
// Hekucoreapp.Infrastructure/Logging is the separate safety net for the case something still gets
// destructured elsewhere). Wraps the whole pipeline so its duration and final status code (incl.
// a 401 from auth failing downstream) are both accurate.
